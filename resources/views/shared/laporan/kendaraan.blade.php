...
<section class="hero" id="heroSection">
    ...
    <div class="hero-actions">
        <a href="{{ route('laporan.kendaraan.export', array_merge(request()->query(), ['format' => 'excel'])) }}" class="btn btn-primary" style="background: #28a745; border-color: #28a745; margin-right: 5px;">Excel</a>
        <a href="{{ route('laporan.kendaraan.export', array_merge(request()->query(), ['format' => 'pdf'])) }}" target="_blank" class="btn btn-primary" style="background: #dc3545; border-color: #dc3545; margin-right: 5px;">PDF</a>
...
<section class="card col-12">
    <div class="card-head" id="filterSection">
        ...
        <form action="{{ route('laporan.kendaraan') }}" method="GET" style="display: flex; gap: 10px; align-items: center;">
            ...
            <a href="{{ route('laporan.kendaraan') }}" class="btn btn--ghost" style="padding: 5px 15px; text-decoration: none;">Reset</a>
        </form>
    </div>
