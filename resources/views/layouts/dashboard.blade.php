            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="{{ url('/') }}" class="flex ml-2 md:mr-24 items-center">
                        <img src="{{ asset('images/bank-nagari-logo.svg') }}" class="h-9 w-auto mr-3" alt="Bank Nagari Logo" />
                        <span class="self-center text-lg font-bold sm:text-xl whitespace-nowrap text-gray-900 dark:text-white">
                            GAS <span class="text-xs font-semibold px-2 py-0.5 rounded bg-primary-100 text-primary-800 dark:bg-primary-900/60 dark:text-primary-300 ml-1 uppercase">{{ Auth::user()->role ?? 'User' }}</span>
                        </span>
                    </a>
                </div>
