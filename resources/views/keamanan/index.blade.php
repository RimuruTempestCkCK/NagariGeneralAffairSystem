                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Keamanan</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Laporan Keamanan</h1>
        </div>
        
        <div class="sm:flex">
            <!-- Filter & Search Form -->
            <form method="GET" action="{{ route('keamanan.index') }}" class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                <div class="flex pl-0 mt-3 space-x-2 sm:pl-2 sm:mt-0">
                    ...
                    <select name="kondisi_keamanan" onchange="this.form.submit()" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    <thead class="bg-gray-100 dark:bg-gray-700">
                        <tr>
                            ...
                            <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Shift / Petugas</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 text-sm text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <span class="ml-2">{{ $p->petugas }}</span>
                            </td>
                            <td class="p-4 text-sm font-bold whitespace-nowrap">
                                @if($p->kondisi_keamanan === 'Aman Kondusif')
                                    <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">Aman Kondusif</span>
                                @else
                                    <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">Insiden / Masalah</span>
                                @endif
                            </td>
                            <td class="p-4 space-x-2 whitespace-nowrap">
                                ...
                                <button type="button" onclick="deleteData({{ $p->id }}, 'laporan keamanan di {{ $p->nama_lokasi }}')" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:focus:ring-red-900">
                                    Hapus
                                </button>
                            </td>
                        </tr>
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white" id="modalFormTitle">Catat Laporan Keamanan</h3>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="date" id="tanggal_laporan" name="tanggal_laporan" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Shift <span class="text-red-500">*</span></label>
                            <select id="shift" name="shift" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Petugas <span class="text-red-500">*</span></label>
                            <input type="text" id="petugas" name="petugas" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kondisi Keamanan <span class="text-red-500">*</span></label>
                        <select id="kondisi_keamanan" name="kondisi_keamanan" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="Aman Kondusif">Aman Kondusif</option>
                            <option value="Insiden / Masalah">Insiden / Masalah</option>
                        </select>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Uraian Kegiatan / Laporan <span class="text-red-500">*</span></label>
                        <textarea id="uraian_kegiatan" name="uraian_kegiatan" required rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tindakan Lanjutan (Jika Ada Insiden)</label>
                        <textarea id="tindakan_lanjutan" name="tindakan_lanjutan" rows="2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                    </div>
                </div>
                <div class="flex items-center p-4 border-t border-gray-200 rounded-b dark:border-gray-700">
                    <button type="submit" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700">Simpan Laporan</button>
...
<div id="modalDetail" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-gray-900/50 backdrop-blur-sm">
    <div class="relative w-full h-full max-w-lg md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Detail Laporan Keamanan</h3>
    ...
    function openDetailModal(id) {
        fetch(`/keamanan/${id}`)
            ...
            .then(data => {
                if (data.success) {
                    const p = data.data;
                    const statusClass = p.kondisi_keamanan === 'Aman Kondusif' 
                    ...
                    document.getElementById('detailContent').innerHTML = `
                        <div class="grid grid-cols-2 gap-4 text-sm bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <div><span class="text-gray-500 block mb-1">Tanggal:</span> <span class="text-gray-900 dark:text-white">${p.tanggal_laporan}</span></div>
                            <div><span class="text-gray-500 block mb-1">Kondisi:</span> <span class="px-2 py-1 rounded text-xs font-semibold ${statusClass}">${p.kondisi_keamanan}</span></div>
                            
                            <div><span class="text-gray-500 block mb-1">Shift:</span> <span class="text-gray-900 dark:text-white">${p.shift}</span></div>
                            <div><span class="text-gray-500 block mb-1">Petugas:</span> <span class="text-gray-900 dark:text-white">${p.petugas}</span></div>
                            
                            <div class="col-span-2 border-t pt-2 mt-2 border-gray-200 dark:border-gray-600">
                                <span class="text-gray-500 block mb-1">Uraian Kegiatan:</span> 
                                <div class="text-gray-900 dark:text-white whitespace-pre-wrap">${p.uraian_kegiatan}</div>
                            </div>
                            
                            <div class="col-span-2 border-t pt-2 mt-2 border-gray-200 dark:border-gray-600">
                                <span class="text-gray-500 block mb-1">Tindakan Lanjutan:</span> 
                                <div class="text-gray-900 dark:text-white whitespace-pre-wrap">${p.tindakan_lanjutan || '-'}</div>
                            </div>
                        </div>
                    `;
            ...
            .catch(err => Swal.fire('Error', 'Gagal memuat detail laporan.', 'error'));
    }
    ...
    function deleteData(id, desc) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const res = await fetch(`/keamanan/${id}`, {
                        method: 'DELETE',
                        headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
