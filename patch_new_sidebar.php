<?php
$code = file_get_contents("C:/Users/Maxtop/source/repos/POSTGRES/Dev ke CI/adminator_templete/2026.js");
$start = strpos($code, "const n=[");
$end = strpos($code, ",M={Day");
...
EOD;
    $newCode = substr($code, 0, $start) . $newSidebar . substr($code, $end);
    file_put_contents("public/adminator_templete/2026.js", $newCode);
    echo "Sidebar injected via PHP to new template.";
}
